...
pub struct QueryTest {
    ...
    pub expected_sql_types: String,
    pub expected_bson_type: String,
    pub expected_catalog_name: String,
    pub expected_column_class_name: String,
    pub expected_column_display_size: String,
    pub expected_column_label: String,
    pub expected_column_type: String,
    pub expected_precision: String,
    pub expected_scale: String,
    pub expected_schema_name: String,
    pub expected_is_auto_increment: String,
    pub expected_is_case_sensitive: String,
    pub expected_is_currency: String,
    pub expected_is_definitely_writable: String,
    pub expected_is_nullable: String,
    pub expected_is_read_only: String,
    pub expected_is_searchable: String,
    pub expected_is_signed: String,
    pub expected_is_writable: String,
    pub ordered: String,
    pub expected_names: String,
    pub sql: String,

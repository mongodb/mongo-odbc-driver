...
mod unit {
    ...
    fn test_connection_alloc_free() {
        unsafe {
            ...
            let mut handle: *mut _ = &mut MongoHandle::Connection(RwLock::new(
                Connection::with_state(std::ptr::null_mut(), ConnectionState::Allocated),
            ));
            let handle_ptr: *mut _ = &mut handle;
            assert_eq!(
                SqlReturn::SUCCESS,
    ...
    fn test_statement_alloc_free() {
        unsafe {
            ...
            let mut handle: *mut _ = &mut MongoHandle::Statement(RwLock::new(

...
impl BsonTypeInfo {
    ...
    pub const WVARCHAR: BsonTypeInfo = BsonTypeInfo {
        ...
        non_concise_type: SqlDataType::EXT_W_CHAR,
        searchable: SQL_SEARCHABLE,
        is_case_sensitive: true,
        fixed_prec_scale: false,
        scale: None,
    ...
    pub const CHAR: BsonTypeInfo = BsonTypeInfo {
        ...
        non_concise_type: SqlDataType::CHAR,
        searchable: SQL_SEARCHABLE,
        is_case_sensitive: true,
        fixed_prec_scale: false,
        scale: None,
    ...
    pub const LONGVARCHAR: BsonTypeInfo = BsonTypeInfo {
        ...
        non_concise_type: SqlDataType::EXT_LONG_VARCHAR,
        searchable: SQL_SEARCHABLE,
        is_case_sensitive: true,
        fixed_prec_scale: false,
        scale: None,
    ...
    pub const WLONGVARCHAR: BsonTypeInfo = BsonTypeInfo {
        ...
        non_concise_type: SqlDataType::EXT_W_LONG_VARCHAR,
        searchable: SQL_SEARCHABLE,
        is_case_sensitive: true,
        fixed_prec_scale: false,
        scale: None,

...
// SQL-1817: Move all definitions to odbc_sys
// This is defined here for speed of development.
pub mod api_definitions {
    ...
    #[derive(Debug, PartialEq, Eq, Clone, Copy, FromPrimitive)]
    pub enum SqlDataType {
        SQL_UNKNOWN_TYPE = super::SqlDataType::UNKNOWN_TYPE as i16,
        SQL_CHAR = super::SqlDataType::CHAR as i16,
        SQL_NUMERIC = super::SqlDataType::NUMERIC as i16,
        SQL_DECIMAL = super::SqlDataType::DECIMAL as i16,
        SQL_INTEGER = super::SqlDataType::INTEGER as i16,
        SQL_SMALLINT = super::SqlDataType::SMALLINT as i16,
        SQL_FLOAT = super::SqlDataType::FLOAT as i16,
        SQL_REAL = super::SqlDataType::REAL as i16,
        SQL_DOUBLE = super::SqlDataType::DOUBLE as i16,
        SQL_DATETIME = super::SqlDataType::DATETIME as i16,
        SQL_VARCHAR = super::SqlDataType::VARCHAR as i16,
        SQL_TYPE_DATE = super::SqlDataType::DATE as i16,
        SQL_TYPE_TIME = super::SqlDataType::TIME as i16,
        SQL_TYPE_TIMESTAMP = super::SqlDataType::TIMESTAMP as i16,
        SQL_TIME_OR_INTERVAL = super::SqlDataType::EXT_TIME_OR_INTERVAL as i16,
        SQL_TIMESTAMP = super::SqlDataType::EXT_TIMESTAMP as i16,
        SQL_LONGVARCHAR = super::SqlDataType::EXT_LONG_VARCHAR as i16,
        SQL_BINARY = super::SqlDataType::EXT_BINARY as i16,
        SQL_VARBINARY = super::SqlDataType::EXT_VAR_BINARY as i16,
        SQL_LONGVARBINARY = super::SqlDataType::EXT_LONG_VAR_BINARY as i16,
        SQL_BIGINT = super::SqlDataType::EXT_BIG_INT as i16,
        SQL_TINYINT = super::SqlDataType::EXT_TINY_INT as i16,
        SQL_BIT = super::SqlDataType::EXT_BIT as i16,
        SQL_WCHAR = super::SqlDataType::EXT_W_CHAR as i16,
        SQL_WVARCHAR = super::SqlDataType::EXT_W_VARCHAR as i16,
        SQL_WLONGVARCHAR = super::SqlDataType::EXT_W_LONG_VARCHAR as i16,
        SQL_GUID = super::SqlDataType::EXT_GUID as i16,
    }

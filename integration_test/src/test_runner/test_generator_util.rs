...
fn get_expected_data_type(sql_type: &Value) -> CDataType {
    match sql_type {
        Value::Number(n) => match FromPrimitive::from_i64(n.as_i64().unwrap()) {
            ...
            Some(SqlDataType::SQL_INTERVAL_DAY) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_YEAR) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_MONTH) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_HOUR) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_MINUTE) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_SECOND) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_YEAR_TO_MONTH) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_DAY_TO_HOUR) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_DAY_TO_MINUTE) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_DAY_TO_SECOND) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_HOUR_TO_MINUTE) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_HOUR_TO_SECOND) => CDataType::Char,
            Some(SqlDataType::SQL_INTERVAL_MINUTE_TO_SECOND) => CDataType::Char,
